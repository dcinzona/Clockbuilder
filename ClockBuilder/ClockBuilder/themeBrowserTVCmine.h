...
@interface themeBrowserTVCmine : UITableViewController < UIAlertViewDelegate, UIActionSheetDelegate, singleColumnPickerActionSheetDelegate,UITextFieldDelegate>{
