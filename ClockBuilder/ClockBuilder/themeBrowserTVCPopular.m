...
#import "themeBrowserTVCPopular.h"
...
@implementation themeBrowserTVCPopular
...
{    
    ...
    if(!_themesListRefreshing){
        ...
        NSString *urlString =[NSString stringWithFormat:@"http://clockbuilder.gmtaz.com/getPopularThemes.php?api=SDFB52f4vw9230V45gdfg&device=iPhone&v=%@",version];            
...
-(void)saveThemeToLocal
{
    ...
    dispatch_async(queue, ^{
        ...
        NSString *downURL = [NSString stringWithFormat:@"http://clockbuilder.gmtaz.com/downloadTheme.php?api=SDFB52f4vw9230V45gdfg&themeName=%@",selectedThemeName];
        NSURL *DOWNURL = [NSURL URLWithString:downURL];
        NSString *updated = [NSString stringWithContentsOfURL:DOWNURL encoding:NSUTF8StringEncoding error:nil];
        NSLog(@"downloads: %@",updated);
