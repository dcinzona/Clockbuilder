...
@implementation themeBrowserAdminTVC
...
{    
    ...
    if(!_themesListRefreshing){
        ...
        NSString *urlString = [NSString stringWithFormat:@"http://clockbuilder.gmtaz.com/getThemes.php?device=iPhone&api=SDFB52f4vw9230V45gdfg"];                   
...
-(void)showActionMenu
{
    ...
    UIActionSheet *actionButtonSheet;
        actionButtonSheet = [[UIActionSheet alloc] initWithTitle:@"" delegate:self cancelButtonTitle:@"Cancel" destructiveButtonTitle:@"Delete and Block" otherButtonTitles:@"Delete", @"Download" ,@"Download and Activate", @"Set Category",  nil]; 
...
{
    NSLog(@"new cat: %@ | theme name: %@",cat,themeName);
