...
+ (id)downloaderWithURL:(NSURL *)url delegate:(id<SDWebImageDownloaderDelegate>)delegate userInfo:(id)userInfo lowPriority:(BOOL)lowPriority
{
    ...
    if (NSClassFromString(@"SDNetworkActivityIndicator"))
    {
        ...
        id activityIndicator = [NSClassFromString(@"SDNetworkActivityIndicator") performSelector:@selector(sharedActivityIndicator)];//NSSelectorFromString(@"sharedActivityIndicator")];
